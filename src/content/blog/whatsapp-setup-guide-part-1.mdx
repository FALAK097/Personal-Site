...
- A Meta Business Manager account set up and ready to go.
...
Save this as your **VERIFY_TOKEN** - you'll need it in your code and Meta dashboard.
...
1. Reply to the test message on WhatsApp
2. Check your webhook endpoint logs
3. You should see a POST request with the message payload
